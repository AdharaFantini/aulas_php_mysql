...
var_dump($fruits[1],$fruits[2]);

echo "<br><br>";
echo "EXERCÍCIO 3";
echo "<br>";
//  Crie um array associativo para estado/capital/data de fundação da capital?
$lugar = array("Estado"=>"Acre", "Capital"=>"Rio Branco", "Data de fundação da capital"=>"28 de dezembro de 1882");
var_dump($lugar);
echo "<br>";
$lugar = array("Estado"=>"Minas Gerais", "Capital"=>"Belo Horizonte", "Data de fundação da capital"=>"12 de dezembro de 1897");
var_dump($lugar);
echo "<br>";
$lugar = array("Estado"=>"Mato Grosso do Sul", "Capital"=>"Campo Grande", "Data de fundação da capital"=>"21 de junho de 1872");
var_dump($lugar);
